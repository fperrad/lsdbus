...
build = {
   ...
   modules = {
      ...
      ["lsdbus.init"]   = "src/lsdbus/init.lua",
      ["lsdbus.common"] = "src/lsdbus/common.lua",
      ["lsdbus.error"]  = "src/lsdbus/error.lua",
      ["lsdbus.proxy"]  = "src/lsdbus/proxy.lua",
      ["lsdbus.server"] = "src/lsdbus/server.lua",
   },
   install = {
      bin = {
         "tools/lsdb-call",
